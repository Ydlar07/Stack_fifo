...
public class StackTest
{
  ...
  public void givenQueueofElements_whenPop_thenReturnlastElementInQueue(){
    ...
    file.queue(ELEMENT_1);
    file.pop();
    int lastElementInQueue = file.listQueue.get(0);
    assertEquals(ELEMENT_2, lastElementInQueue);
  }

  @Test
  public void givenOneElementInQueue_whenPop_thenQueueEmpty(){
    file.queue(ELEMENT_1);
    file.pop();
  ...
  @Test
  public void givenElements_wendPopOneElement_thenQueueNotEmpty(){
  file.queue(ELEMENT_1);
  file.queue(ELEMENT_2);
  file.queue(ELEMENT_1);
  file.pop();
